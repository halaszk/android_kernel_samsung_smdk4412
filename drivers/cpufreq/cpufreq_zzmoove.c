 ...
 */
static int mn_freqs[19][5]={
    {2000000,2000000,1920000, 2000000, 1740000},
    {1920000,1920000,1800000, 1920000, 1600000},
    {1800000,1800000,1704000, 1800000, 1500000},
    {1704000,1704000,1600000, 1704000, 1400000},
 ...
 * zzmoove v0.4 - added fast scaling columns to frequency table
 */
static int mn_freqs_power[19][5]={
    {2000000,1920000,1920000, 2000000, 1800000},
    {1920000,1800000,1800000, 1920000, 1704000},
    {1800000,1704000,1704000, 1800000, 1600000},
    {1704000,1704000,1600000, 1704000, 1500000},
    {1600000,1600000,1500000, 1600000, 1400000},
    {1500000,1600000,1400000, 1600000, 1300000},
    {1400000,1600000,1300000, 1600000, 1200000},
    {1300000,1500000,1200000, 1600000, 1100000},
    {1200000,1400000,1100000, 1400000, 1000000},
    {1100000,1300000,1000000, 1400000,  900000},
    {1000000,1200000, 900000, 1400000,  800000},
    { 900000,1100000, 800000, 1200000,  700000},
    { 800000,1000000, 700000, 1200000,  500000},
    { 700000, 900000, 600000, 1000000,  400000},
    { 600000, 800000, 500000, 1000000,  400000},
    { 500000, 700000, 400000,  800000,  300000},
					  ...
					  const char *buf, size_t count)
{
	...
	int ret;
	int i=0;
	int valid_freq[20]={0, 2000000, 1920000, 1800000, 1704000, 1600000, 1500000, 1400000, 1300000, 1200000, 1100000, 1000000, 900000, 800000, 700000, 600000, 500000, 400000, 300000, 200000};
	ret = sscanf(buf, "%u", &input);

	if (ret != 1 || input > 2000000 || (input < 200000 && input != 0))
		return -EINVAL;
